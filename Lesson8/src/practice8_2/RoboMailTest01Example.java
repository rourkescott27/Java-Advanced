...
import java.util.List;  // This allows us to work with lists of objects
import java.util.function.Predicate;  // This allows us to create filter conditions
 ...
 */
public class RoboMailTest01Example {
